 ...
 * @author davidleber
 */
public class TPERMODEditRelationshipPage extends ERD2WPage implements ERMEditRelationshipPageInterface, SelectPageInterface {
  /**
  ...
  private static final long serialVersionUID = 1L;
	...
	public TPERMODEditRelationshipPage(WOContext context) {
        super(context);
    }
