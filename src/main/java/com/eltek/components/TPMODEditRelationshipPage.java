 ...
 * @author davidleber
 */
public class TPMODEditRelationshipPage extends ERD2WPage implements ERMEditRelationshipPageInterface, SelectPageInterface {
	...
	public TPMODEditRelationshipPage(WOContext context) {
        super(context);
    }
	...
	public WOComponent newObjectAction() {
		System.out.println("newObjectAction ");
		ERXThreadStorage.takeValueForKey(masterObject(), "workingPerson");
...
//								+ "HAS CHANGES; " + eo + " - " + masterObject() + "  " + relationshipKey + " - " + relationshipKey() +"***");
  ...
  public NSArray<EOSortOrdering> sortOrderings() {
	...
	/*
	 * from R2D2WEditRelastionshipPage to fix the batchsize problem above.
	 *    
	 */
//	public int numberOfObjectsPerBatch() {
//		int batchSize = 0;
...
//	}
	...
	public void setMasterObject(EOEnterpriseObject masterObject) {
		System.out.println("masterObject = " + masterObject.entityName());
